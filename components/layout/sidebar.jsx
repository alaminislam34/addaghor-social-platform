...
export function Sidebar({ isOpen, onClose }) {
  ...
  return (
    <>
      ...
      <aside
        className={cn(
          "fixed border border-black h-[94svh] top-0 left-0 z-50 w-72 bg-card border-r transform transition-transform duration-300 ease-in-out lg:translate-x-0 lg:static lg:z-auto",
